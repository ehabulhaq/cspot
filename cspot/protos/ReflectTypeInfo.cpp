...
ReflectType::ofEnum(/* mine id */ ReflectTypeID::EnumReflectTypeID, /* name */ "ReflectTypeID", /* enum values */ std::move(std::vector<ReflectEnumValue>{   ReflectEnumValue("EnumReflectTypeID", 0),
   ...
   ReflectEnumValue("UnsignedChar", 7),
   ReflectEnumValue("Double", 8),
   ReflectEnumValue("Float", 9),
   ReflectEnumValue("String", 10),
   ReflectEnumValue("Int64", 11),
   ReflectEnumValue("Uint32", 12),
   ReflectEnumValue("Int", 13),
   ReflectEnumValue("Bool", 14),
   ReflectEnumValue("Int32", 15),
   ReflectEnumValue("Uint64", 16),
   ReflectEnumValue("Uint8", 17),
   ReflectEnumValue("Char", 18),
